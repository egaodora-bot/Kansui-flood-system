...
st.markdown("<h3 style='font-size: 20px; font-weight: bold; margin-bottom: 0rem; color: #1e90ff; text-shadow: 1px 1px 2px rgba(0,0,0,0.3), 0 0 10px rgba(30,144,255,0.4);'>🌧️ 全日本 一級河川・道路交通 リアルタイムモニタリング</h3>", unsafe_allow_html=True)
...
# サイドバーのタイトルも立体的な青文字に修正
st.sidebar.markdown("<h3 style='font-size: 16px; font-weight: bold; color: #1e90ff; text-shadow: 1px 1px 2px rgba(0,0,0,0.3), 0 0 8px rgba(30,144,255,0.4); margin-bottom: 0px;'>🌧️ 全日本 一級河川・道路交通 リアルタイムモニタリング</h3>", unsafe_allow_html=True)
st.sidebar.markdown("---")
